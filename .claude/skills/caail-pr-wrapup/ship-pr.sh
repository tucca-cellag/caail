...
TEST_PATHS='site/** workers/** *.md ResearchAreas/** Datasets/** Primers/** Methods/** .claude/hooks/** .claude/settings.json .github/workflows/test.yml CITATION.cff .github/ISSUE_TEMPLATE/** plugin-contribute/**'
