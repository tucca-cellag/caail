...
LINT_PAPERS_PATHS='Papers.md Software.md Databases.md FieldReports.md OtherResources.md Taxonomy.md Datasets/** CONTRIBUTING.md CLAUDE.md site/scripts/parser/** site/scripts/db/** site/db/** site/public/api/** site/public/setup.md plugin/skills/** skills/** .claude/skills/matrix-classification-audit/** plugin-contribute/** .github/ISSUE_TEMPLATE/**'
TEST_PATHS='site/** workers/** *.md ResearchAreas/** Datasets/** Primers/** Methods/** .claude/hooks/** .claude/settings.json .claude/skills/matrix-classification-audit/README.md .claude/skills/matrix-classification-audit/docling_sections.py .claude/skills/matrix-classification-audit/docling_sections.test.py .claude/skills/matrix-classification-audit/extract_matrix_corpus.py .github/workflows/test.yml CITATION.cff .github/ISSUE_TEMPLATE/** plugin-contribute/** .gitignore .worktreeinclude .env.example'
