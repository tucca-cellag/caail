...
TEST_PATHS='site/** workers/** *.md ResearchAreas/** Datasets/** Primers/** .claude/hooks/** .claude/settings.json plugin/skills/** plugin/.claude-plugin/** .claude-plugin/** .github/workflows/test.yml'
