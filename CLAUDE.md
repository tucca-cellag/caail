...
Funding.md             Funding bodies + funding opportunities (grant programs, mechanisms)
...
4. **Funding → `Funding.md`** — funding bodies and funding opportunities (grant programs, research-portfolio mechanisms).
...
- **`Funding.md`** — `## Funding Bodies` and `## Funding Opportunities & Programs`.
