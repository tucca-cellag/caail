...
describe('Taxonomy.md ⨯ Papers.md (real files)', () => {
  ...
  // let the theme's blurb overwrite the column's scope. Splitting the axes removed the
  // clash at source by renaming the theme to `Bioprocess & Manufacturing`, so this now
