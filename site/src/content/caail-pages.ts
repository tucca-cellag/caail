...
const PAGES: Record<string, PageMeta> = {
  ...
  'other-resources': {
    ...
    order: 2,
    description:
      'Journal editorials and opinion on AI in science and in animal agriculture, and cellular-agriculture ecosystem initiatives: research centers, consortia, and convening efforts.',
