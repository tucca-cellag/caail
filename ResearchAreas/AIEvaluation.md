...
| CompBioBench v1 Leaderboard (Genentech) | 2026 | Computational biology | Vendor-neutral leaderboard tracking model performance across CompBioBench tasks | Continuously updated leaderboard, no companion paper | [Databases.md](../Databases.md#compbiobench-v1-leaderboard) |
...
- **CompBioBench v1 Leaderboard** (Genentech) — open Hugging Face Space leaderboard tracking model performance across the CompBioBench computational-biology benchmark suite; vendor-neutral, continuously updated, no separate paper. See [Databases.md / CompBioBench v1 Leaderboard](../Databases.md#compbiobench-v1-leaderboard).
