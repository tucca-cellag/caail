...
|---|---|---|---|---|---|
| [#146 LAB-Bench](../Papers.md#146) (Laurent et al. 2024, FutureHouse) | 2024 | Biology research | Practical lab tasks (literature, figure reading, protocols, DNA/protein sequence ops, cloning, database access) | 2,400+ multiple-choice questions across 8 task types | [Software.md](../Software.md#lab-bench) · [Datasets.md](../Datasets.md#lab-bench) |
| [#108 BixBench](../Papers.md#108) (Mitchener et al. 2025, FutureHouse) | 2025 | Computational biology | Multi-step bioinformatics workflows derived from peer-reviewed papers and their code/data | 50+ real-world scenarios | [Software.md](../Software.md#bixbench) |
| [#147 BLADE](../Papers.md#147) (Gu et al. 2025) | 2025 | Data-driven science | Open-ended data-analysis tasks requiring decision-making across analytical paths | 12 datasets × 100s of expert decisions | [Software.md](../Software.md#blade) |
...
| [#109 MassSpecGym](../Papers.md#109) (Bushuiev et al. 2024) | 2024 | Mass spectrometry | MS/MS-spectra → molecular structure (de novo + database retrieval + classification) | NeurIPS 2024 Datasets & Benchmarks Spotlight | [Software.md](../Software.md#massspecgym) |
...
| [#148 ProteinGym](../Papers.md#148) (Notin et al. 2023, Marks lab) | 2023 | Protein design | Variant-effect prediction (DMS substitutions + indels) and clinical-variant classification | 200+ DMS assays, 2.5M+ mutated sequences | [proteingym.org](https://proteingym.org/) |
| [#127 CausalBench](../Papers.md#127) (Chevalley et al. 2025) | 2025 | Single-cell perturbation | Network inference from single-cell perturbation data | Large-scale CRISPR-perturbation benchmark | [GitHub](https://github.com/causalbench/causalbench) |
...
| CompBioBench v1 Leaderboard (Genentech) | 2026 | Computational biology | Vendor-neutral leaderboard tracking model performance across CompBioBench tasks | Continuously updated leaderboard, no companion paper | [Software.md](../Software.md#compbiobench-v1-leaderboard) |
...
- [#146 LAB-Bench](../Papers.md#146) (Laurent et al. 2024, FutureHouse) — 2,400+ MCQs across literature reading, figure interpretation, protocol design, DNA/protein sequence manipulation, cloning, and database access. The single broadest practical-biology eval at time of curation, and the FutureHouse counterpart to [#108 BixBench](../Papers.md#108). Scoring code at [Software.md / LAB-Bench](../Software.md#lab-bench); HF eval dataset at [Datasets.md / LAB-Bench](../Datasets.md#lab-bench).
- [#108 BixBench](../Papers.md#108) (Mitchener et al. 2025, FutureHouse) — 50+ end-to-end bioinformatics scenarios derived from peer-reviewed papers + their associated code and data; complements LAB-Bench's atomized question format with full multi-step task execution. Code at [Software.md / BixBench](../Software.md#bixbench).
- [#147 BLADE](../Papers.md#147) (Gu et al. 2025) — evaluates agents on open-ended data analysis where the "correct" answer is a defensible analytical path, not a single value; built around 12 datasets and hundreds of expert decisions. Pairs with the same authors' [#151 / #152 Gu CHI 2024](../Papers.md#151) studies on how humans actually use AI assistants for analysis. Project site at [Software.md / BLADE](../Software.md#blade).
...
- **CompBioBench v1 Leaderboard** (Genentech) — open Hugging Face Space leaderboard tracking model performance across the CompBioBench computational-biology benchmark suite; vendor-neutral, continuously updated, no separate paper. See [Software.md / CompBioBench v1 Leaderboard](../Software.md#compbiobench-v1-leaderboard).
...
- [#148 ProteinGym](../Papers.md#148) (Notin et al. 2023, Marks lab) — the dominant variant-effect benchmark; 200+ deep mutational scanning assays plus clinical variant tasks across substitutions and indels. Directly relevant to any cell-ag protein-engineering work (growth factors, scaffolds, recombinant ECM proteins) that uses a protein language model. Distributed via [proteingym.org](https://proteingym.org/).
- [#109 MassSpecGym](../Papers.md#109) (Bushuiev et al. 2024, Pluskal lab; NeurIPS 2024 Datasets & Benchmarks Spotlight) — MS/MS → structure benchmark with de novo, database-retrieval, and chemical-class prediction sub-tasks. The cleanest existing substrate for ML-based flavor-compound identification in cell-ag sensomics workflows. Code at [Software.md / MassSpecGym](../Software.md#massspecgym).
...
- [#127 CausalBench](../Papers.md#127) (Chevalley et al. 2025) — large-scale benchmark for network inference from single-cell perturbation data; the closest cell-ag-relevant eval suite for any model that promises to infer regulatory networks driving lineage commitment or response to media perturbations.
