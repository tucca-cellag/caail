...
- Adjacent research areas: [Media Optimization](./MediaOptimization.md), [Cellular Engineering](./CellEngineering.md), [Bioprocess & Scale-Up](./Bioprocess.md), [Sensory Prediction](./SensoryPrediction.md), [Metabolic Modeling](./MetabolicModeling.md).
